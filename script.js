...
class App {
  ...
  _getPosition() {
    if (navigator.geolocation) {
      // one kind of callback so (())is not given
      //this is a regular function call so this is undefined, use bind so that we can call later
  ...
  _loadPosition(position) {
    ...
    // this is a special object generated by leaflet
  ...
  //to reach clicked workout on map
  _moveToPopup(event) {
